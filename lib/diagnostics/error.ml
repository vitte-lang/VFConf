...
let code_of_kind = function
  ...
  | Include_not_found _ -> "VF0301"
  | Include_cycle _ -> "VF0302"
  | Include_depth_exceeded _ -> "VF0303"
  | Invalid_include _ -> "VF0304"

  | Schema_violation _ -> "VF0401"
  | Missing_required_field _ -> "VF0402"
  | Unknown_field _ -> "VF0403"

  | Evaluation_failed _ -> "VF0501"
  | Division_by_zero -> "VF0502"

  | File_not_found _ -> "VF0601"
  | Cannot_read_file _ -> "VF0602"

  | Internal_error _ -> "VF9001"
